  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.profileCompleted) {
        // Redirect to dashboard/main app (you can create this component later)
        navigate('/dashboard');
      } else {
        // Redirect to profile completion page (you can create this component later)
        ...
        <div className="pt-10">
          ...
          <div className="px-8 py-8">
            <form onSubmit={handleSubmit} className="space-y-0">
              ...
              {/* Forgot Password (aligned right, below password field) */}
              <div className="flex justify-end" style={{marginBottom: '50px'}}>
                <button
                  type="button"
                  onClick={handleForgotPassword}
                  className="text-green-400 text-base py-2"
                >
                  Forgot password?
                </button>
              </div>
